                    ...
                    <div class="col-lg-8">
                        ...
                        <form role="form" id="frmUser" method="post" action="crudUser.php?action=crear">
                            <div class="form-group">
                                <label>Nombres</label>
                                <input id="nombres" name="nombres" class="form-control" placeholder="Ej. Victor Alfonso" required>
                                <p class="help-block">Nombres completos del usuario.</p>
                            </div>

                            <div class="form-group">
                                <label>Apellidos</label>
                                <input id="apellidos" name="apellidos" class="form-control" placeholder="Ej. Rodriguez Gutierrez" required>
                                <p class="help-block">Apellidos completos del usuario.</p>
                            </div>

                            <div class="form-group">
                                <label>Direccion</label>
                                <input id="direccion" name="direccion" class="form-control" placeholder="Ej. Cra  9 #10-23" required>
                                <p class="help-block">Direcci&oacute;n donde vive el usuario.</p>
                            </div>
